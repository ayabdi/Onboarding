...
const EmailModalForm = ({ show, close ,hirename}) => {

  const {handleChange, emailData} = useEmailForm();
  ...
  return (
    ...
    >
          ...
          <div className="modal-content column">
            <form className="modal-form">
              ...
              <label className="conrol-label">Message</label>
                  <textarea type="textarea" className="form-control text-box-large" 
                  name="message"
        ...
        <div className="col right" >
          ...
          <div className="modal-content row" style = {{border: '0'}}>
            <div className =  'preview row' >
               <p style= {{fontWeight: 'bold'}}>To:  </p> &nbsp; {emailData.to} {/* add to name */} 
            </div>
            <div className =  'preview row' >
               <p style= {{fontWeight: 'bold'}}>From: </p> &nbsp; {emailData.from}
            </div>
            <div className =  'preview row' >
               <p style= {{fontWeight: 'bold'}}>Date: </p> {/* add date */}
            </div>
            <br/>
            <div className =  'preview row' >
               <p style= {{fontWeight: 'bold'}}>Subject: </p> &nbsp; {/* add subject*/} {emailData.subject}
            </div>
            <div className ='preview row'>
              <br/>
              {/* add message */}
      ...
      <div className="modal-footer">
        <button onClick={close} className="btn btn-primary btn-sm mod" style = {{backgroundColor: ' #4a208e'}}>
          Close
        </button>
      </div>
    </div>
