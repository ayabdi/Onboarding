      ...
      <div className="row">
        <div className="col-md-10" style={{ width: "60%" }}>
          ...
          <p className="card-text ">
            Email reminders will be sent out in # of days before task due date,
            if 
          </p>
        </div>
        <TaskModalForm
        ...
        <>
          {tasks.length > 0 && isSubmitting ? (
            <div className="container email-preview titles" style={{marginBottom: '0'}}>
          ...
          {isSubmitting
            ? tasks.map((task, i) => (
                <div key={i} className="container email-preview">
                  <div className="row email-preview">
                    <div className="col-sm-3 email-preview">{task.task}</div>
                    <div
                      className="col-sm-3 email-preview"
                      style={{ margin: "8px" }}
                    >
