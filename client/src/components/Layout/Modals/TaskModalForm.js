...
const TaskModalForm = ({ hireForm, render, currentStep }) => {
  ...
  const btnactive = {marginBottom: "40px",
  marginRight: "22%",
  height: "32px",
  width: "130px",
  top: "-10px",
  padding: "7px", opacity: '1', pointerEvents: 'auto' }
    ...
    <>
      <div className="col-sm-3 float-right">
        <button
          ...
          style={ currentStep === 3 ? btnactive: btnStyle}
        >
          Create a task
        </button>
      </div>
            ...
            <div className="col right">
              <div className="modal-content column">
                ...
                <div className="modal-content row" style={{ border: "0" }}>
                    ...
                    {reminderArr.map((reminder, i) => (
                      <div key={i}>
                        ...
                        {i < 3
                          ? addDays(
                              hireForm.startDate,
                              -reminderArr[i] - taskData.due_date
                  ...
                  <br />
                  <div className="preview row">
                    <p className="preview-labels">Subject: </p> &nbsp; Automated
                    Email Reminder from {taskData.from}
                  </div>
                  <div className="preview row">
                    <br />
